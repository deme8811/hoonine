	...
	<center>
		...
		<form action="goodsInsert.do" method="post"
			...
			<table width="1100px" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="30px">
					<td align="center" rowspan="6" width="400px"></td>
					<td width="100px"></td>
				...
				<tr>
					<td width="1100px"><textarea cols="1100px" rows="50px"
							name=gContent></textarea></td>
				</tr>

				<tr height="30px">
					<td colspan="4" align="right"><input type="submit"
						value="목록으로"> <input type="reset" value="다시쓰기"> <input
